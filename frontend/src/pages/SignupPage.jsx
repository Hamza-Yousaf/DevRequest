        ...
        <div className="flex justify-center items-center h-full w-full">
            <div className="w-100 h-150 bg-emerald-800 p-10 flex flex-col justify-between" >
                <div className="flex flex-col">
                    ...
                    <input type="email" placeholder='Email' className='relative w-full mt-4 p-2 bg-white rounded-sm border-2 border-gray-300 focus:border-orange-200 focus:border-2 focus:outline-none'
                    value={newUser.email}
